...
public abstract class AbstractHadoopBdbStoreBuilderMapper<K, V> extends
        AbstractBdbStoreBuilderConfigurable implements Mapper<K, V, BytesWritable, BytesWritable> {
